...
class rankine():
    ...
    def calc_efficiency(self):
        ...
        if(self.t_high==None):
            ...
            self.state1= steam(self.t_high, x=1, name='Turbine Inlet') # instantiate a steam object with conditions of state 1 at t_high, named 'Turbine Inlet'
        ...
        self.pump_work=self.state3.v * (self.p_high - self.p_low) # calculate pump work
...
def main():
    rankine1=rankine(p_low=8, p_high=8000, name='Saturated Vapor Cycle') #instantiate a rankine object to test it.
    #t_high is specified
